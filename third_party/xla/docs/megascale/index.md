...
# Megascale Debugging Playbook

Cloud TPU Multislice environments are composed of multiple TPU slices that
communicate over the Data Center Network (DCN). Multislice workloads use
Megascale collectives to communicate over DCN.

To learn more about Megascale, check out the terminologies section below. This
[guide](./debugging/playbook.md) discusses how to identify and diagnose sources
